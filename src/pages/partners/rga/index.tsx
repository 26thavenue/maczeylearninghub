...
const Index = () => {
  ...
  return (
    <main className="p-8 lg:p-24">
      <div className=" p-8 rounded-lg flex  gap-16  items-center ">
      ...
      <section className="flex flex-col gap-16 my-24">
        ...
        <div className="my-24">
          ...
          <div className="flex gap-16 items-center my-12 ">
            <img src={HighschoolImg} alt="HighSchool Image" className='h-[400px] w-[400px] object-contain'/>
          ...
          <div className="flex gap-16 items-center my-16 ">
            <img src={collegeImg} alt="HighSchool Image" className='h-[400px] w-[400px] object-contain'/>
            <div className="text-lg flex flex-col gap-4">
